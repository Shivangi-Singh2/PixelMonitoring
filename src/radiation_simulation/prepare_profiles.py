...
def __get_and_write_fill_measurement(
    ...
    global last_valid_fill, fake_fill_number, last_valid_fluence    #change
...
#...............................................................................
    if fill_number == 0 or fill_number == NA_VALUE:
        if last_valid_fill is not None:
            fake_fill_number += 1
            fill_number = last_valid_fill + fake_fill_number
            fluence = last_valid_fluence if last_valid_fluence is not None else 0
        else:
            fill_number = NA_VALUE

    else:
        last_valid_fill = fill_number
        fake_fill_number = 0
        last_valid_fluence = fluence
    line = PROFILE_FORMAT % (
    fill_number,
