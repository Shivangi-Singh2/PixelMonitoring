...
if [ "$year" == "2015" ]; then
    ...
    ranges=(
        ...
        8010 8340 8400 8400 8480 8490
        8530 8570 8600 8700 8800 8900 
	9000 9100 9200
    )
elif [ "$year" == "2023" ]; then
    fill_info=data/fills_info/fills_run3.csv
    ranges=(
        9200 9230 9260 9290 9320 9350
        9380 9410 9440 9470 9500 9530
        9560 9590 9620 9650 9680 9710
        9740 9770 9800 9830 9860 9890
        9920 9950 9980 10010 10040 10070
        10100 10130 10160 10190 10220 10250
        10280 10310 10340
    )
...
for ((i_range=0; i_range<${n_ranges}; i_range++)); do
    ...
    python src/radiation_simulation/prepare_profiles.py -ff ${first_fill} -lf ${last_fill} -rog ${rog} ${time_flags} -o ${output_directory} -p ${profile} -i ${fill_info} -skip > ${log_file} 2>&1 &
