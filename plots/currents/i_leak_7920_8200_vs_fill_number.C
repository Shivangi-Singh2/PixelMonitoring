...
//=========  (Fri Apr  4 20:42:24 2025) by ROOT version 6.34.04
   ...
   Double_t Graph_fx1[72] = { 7920, 7921, 7923, 7960, 7963, 7965, 7966, 7967, 7969, 7978, 8007, 8016, 8017, 8018, 8019, 8020, 8022,
   8023, 8027, 8030, 8033, 8043, 8046, 8057, 8058, 8059, 8062, 8063, 8067, 8068, 8072, 8073, 8076,
   8078, 8079, 8081, 8083, 8087, 8088, 8091, 8094, 8098, 8099, 8100, 8102, 8103, 8106, 8108, 8111,
   8112, 8113, 8115, 8118, 8120, 8121, 8124, 8125, 8128, 8132, 8136, 8142, 8143, 8144, 8146, 8147,
   8148, 8149, 8151, 8177, 8178, 8181, 8184 };
   ...
   TH1F *Graph_Graph1 = new TH1F("Graph_Graph1","Layer 1",100,7893.6,8210.4);
   ...
   Double_t Graph_fx2[72] = { 7920, 7921, 7923, 7960, 7963, 7965, 7966, 7967, 7969, 7978, 8007, 8016, 8017, 8018, 8019, 8020, 8022,
   8023, 8027, 8030, 8033, 8043, 8046, 8057, 8058, 8059, 8062, 8063, 8067, 8068, 8072, 8073, 8076,
   8078, 8079, 8081, 8083, 8087, 8088, 8091, 8094, 8098, 8099, 8100, 8102, 8103, 8106, 8108, 8111,
   8112, 8113, 8115, 8118, 8120, 8121, 8124, 8125, 8128, 8132, 8136, 8142, 8143, 8144, 8146, 8147,
   8148, 8149, 8151, 8177, 8178, 8181, 8184 };
   ...
   TH1F *Graph_Graph2 = new TH1F("Graph_Graph2","Layer 2",100,7893.6,8210.4);
   ...
   Double_t Graph_fx3[72] = { 7920, 7921, 7923, 7960, 7963, 7965, 7966, 7967, 7969, 7978, 8007, 8016, 8017, 8018, 8019, 8020, 8022,
   8023, 8027, 8030, 8033, 8043, 8046, 8057, 8058, 8059, 8062, 8063, 8067, 8068, 8072, 8073, 8076,
   8078, 8079, 8081, 8083, 8087, 8088, 8091, 8094, 8098, 8099, 8100, 8102, 8103, 8106, 8108, 8111,
   8112, 8113, 8115, 8118, 8120, 8121, 8124, 8125, 8128, 8132, 8136, 8142, 8143, 8144, 8146, 8147,
   8148, 8149, 8151, 8177, 8178, 8181, 8184 };
   ...
   TH1F *Graph_Graph3 = new TH1F("Graph_Graph3","Layer 3",100,7893.6,8210.4);
   ...
   Double_t Graph_fx4[72] = { 7920, 7921, 7923, 7960, 7963, 7965, 7966, 7967, 7969, 7978, 8007, 8016, 8017, 8018, 8019, 8020, 8022,
   8023, 8027, 8030, 8033, 8043, 8046, 8057, 8058, 8059, 8062, 8063, 8067, 8068, 8072, 8073, 8076,
   8078, 8079, 8081, 8083, 8087, 8088, 8091, 8094, 8098, 8099, 8100, 8102, 8103, 8106, 8108, 8111,
   8112, 8113, 8115, 8118, 8120, 8121, 8124, 8125, 8128, 8132, 8136, 8142, 8143, 8144, 8146, 8147,
   8148, 8149, 8151, 8177, 8178, 8181, 8184 };
   ...
   TH1F *Graph_Graph4 = new TH1F("Graph_Graph4","Layer 4",100,7893.6,8210.4);
   ...
   multigraph->Add(graph,"");
   multigraph->Draw("AP");
   multigraph->GetXaxis()->SetLimits(7906.8, 8197.2);
   ...
   leg->SetFillColor(0);
   leg->SetFillStyle(0);
   TLegendEntry *entry=leg->AddEntry("Graph","Layer 0","P");
   ...
   entry=leg->AddEntry("Graph","Layer 1","P");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(1);
   ...
   entry->SetMarkerSize(0.8);
   entry->SetTextFont(42);
   entry=leg->AddEntry("Graph","Layer 2","P");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(1);
   ...
   entry->SetMarkerSize(0.8);
   entry->SetTextFont(42);
   entry=leg->AddEntry("Graph","Layer 3","P");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(1);
